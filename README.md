...
- [Web Scraper](https://github.com/PuuperttiRuma/web-scraper). Webcrawler for analyzing webpages.
- [Niri sessions](https://github.com/PuuperttiRuma/niri-sessions). Tool for [Niri Wayland compositor](https://github.com/niri-wm/niri) which saves and loads open windows between system shutdowns.
